...
<div class="container">
    ...
    <div class="row margin-top">
        <div class="col-md-7">
                <img   src="http://dndgroup.kr/assets/img/31.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
            <div class="portfolio-header">BONGCHEON OFFICE BUILDING</div>
            <br>
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://dndgroup.kr/assets/img/32.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
