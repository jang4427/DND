...
<div class="container">
    ...
    <div class="row margin-top">
        <div class="col-md-7">
            <a href="portfolio-item.html">
                <img class="img-hover" src="http://127.0.0.1:8888/assets/img/16.jpg" alt="photo"/>
            </a>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
            <a href="portfolio-item.html">
                <img class="img-hover" src="http://127.0.0.1:8888/assets/img/17.jpg" alt="photo"/>
            </a>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
            <a href="portfolio-item.html">
                <img class="img-hover" src="http://127.0.0.1:8888/assets/img/18.jpg" alt="photo"/>
            </a>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
            <a href="portfolio-item.html">
                <img class="img-hover" src="http://127.0.0.1:8888/assets/img/19.jpg" alt="photo"/>
            </a>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
            <a href="portfolio-item.html">
                <img class="img-hover" src="http://127.0.0.1:8888/assets/img/20.jpg" alt="photo"/>
            </a>
        </div>
        <div class="col-md-5">
