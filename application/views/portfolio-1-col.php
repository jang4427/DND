...
<!--                    </li>-->
    ...
    <div class="container">
        ...
        <div class="row margin-top">
            <div class="col-md-7">
                   <img src="http://gotqks2.cafe24.com/assets/img/1.jpg" alt="photo"/>
            </div>
            <div class="col-md-5">
        ...
        <div class="row">
            <div class="col-md-7">
                   <img src="http://gotqks2.cafe24.com/assets/img/2.jpg" alt="photo"/>
            </div>
            <div class="col-md-5">
        ...
        <div class="row">
            <div class="col-md-7">
                    <img src="http://gotqks2.cafe24.com/assets/img/3.jpg" alt="photo"/>
            </div>
            <div class="col-md-5">
        ...
        <div class="row">
            <div class="col-md-7">
                   <img src="http://gotqks2.cafe24.com/assets/img/4.jpg" alt="photo"/>
            </div>
            <div class="col-md-5">
        ...
        <div class="row">
            <div class="col-md-7">
                   <img  src="http://gotqks2.cafe24.com/assets/img/5.jpg" alt="photo"/>
            </div>
            <div class="col-md-5">
