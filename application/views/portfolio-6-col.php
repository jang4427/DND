...
<div class="container">
    ...
    <div class="row margin-top">
        <div class="col-md-7">
                <img   src="http://dndgroup.kr/assets/img/26.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://dndgroup.kr/assets/img/27.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://dndgroup.kr/assets/img/28.jpg" alt="photo"/>
        </div>
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://dndgroup.kr/assets/img/29.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://dndgroup.kr/assets/img/30.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row text-center">
        <div class="col-md-12">
            <ul class="pagination">
                <li>
                    <a href="http://dndgroup.kr/controlls/portfolio/1">1</a>
                </li>
                <li>
                    <a href="http://dndgroup.kr/controlls/portfolio/2">2</a>
                </li>
                <li>
                    <a href="http://dndgroup.kr/controlls/portfolio/3">3</a>
                </li>
                <li>
                    <a href="http://dndgroup.kr/controlls/portfolio/4">4</a>
                </li>
                <li>
                    <a href="http://dndgroup.kr/controlls/portfolio/5">5</a>
                </li>
                <li class="active">
                    <a href="http://dndgroup.kr/controlls/portfolio/6">6</a>
                </li>
                <li>
                    <a href="http://dndgroup.kr/controlls/portfolio/7">7</a>
                </li>
            </ul>
        </div>
    </div>
