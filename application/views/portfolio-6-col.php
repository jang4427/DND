...
<div class="container">
    ...
    <div class="row margin-top">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/26.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/27.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/28.jpg" alt="photo"/>
        </div>
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/29.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/30.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
