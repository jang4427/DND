...
<div class="container">
    ...
    <div class="row margin-top">
        <div class="col-md-7">
            <a href="portfolio-item.html">
                <img class="img-hover" src="http://127.0.0.1:8888/assets/img/21.jpg" alt="photo"/>
            </a>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
            <a href="portfolio-item.html">
                <img class="img-hover" src="http://127.0.0.1:8888/assets/img/22.jpg" alt="photo"/>
            </a>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
            <a href="portfolio-item.html">
                <img class="img-hover" src="http://127.0.0.1:8888/assets/img/23.jpg" alt="photo"/>
            </a>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
            <a href="portfolio-item.html">
                <img class="img-hover" src="http://127.0.0.1:8888/assets/img/24.jpg" alt="photo"/>
            </a>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
            <a href="portfolio-item.html">
                <img class="img-hover" src="http://127.0.0.1:8888/assets/img/25.jpg" alt="photo"/>
            </a>
        </div>
        <div class="col-md-5">
