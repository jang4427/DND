...
<div class="container">
    ...
    <div class="row margin-top">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/21.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/22.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/23.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/24.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/25.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row text-center">
        <div class="col-md-12">
            <ul class="pagination">
                <li>
                    <a href="http://localhost/controlls/portfolio/1">1</a>
                </li>
                <li>
                    <a href="http://localhost/controlls/portfolio/2">2</a>
                </li>
                <li>
                    <a href="http://localhost/controlls/portfolio/3">3</a>
                </li>
                <li>
                    <a href="http://localhost/controlls/portfolio/4">4</a>
                </li>
                <li class="active">
                    <a href="http://localhost/controlls/portfolio/5">5</a>
                </li>
                <li>
                    <a href="http://localhost/controlls/portfolio/6">6</a>
                </li>
                <li>
                    <a href="http://localhost/controlls/portfolio/7">7</a>
                </li>
            </ul>
        </div>
    </div>
