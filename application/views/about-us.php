    ...
    <div class="container">
        ...
        <div class="row margin-top">
            <div class="col-md-6 col-sm-6">
                <h3>- 2015</h3>
                  <p>인천 중구 항동 어시장 신축 계획</p>
                  <p class="inner-text">Korea / Incheon Hang-dong Fish Market Project</p>
                <p>서초동 업무시설 신축 계획
                   </p>
                <p class="inner-text">Korea / Seoul Seocho Office Project</p>
                <p>서초동 근린생활시설 신축 계획</p>
        ...
        <div class="row margin-top">
            <div class="col-md-6 col-sm-6">
                ...
                <p>자양동 이씨종회 리모델링설계감리</p>
                <p class="inner-text">Korea / Seoul Jayang-dong Lee’s Family Office</p>
                <p>자곡동 단독주택 신축 계획</p>
                <p class="inner-text">Korea / Seoul Jagok House Project</p>
        ...
        <div class="row margin-top">
            <div class="col-md-6 col-sm-6">
                ...
                <p class="inner-text">Korea / Seoul Yeoksam Office Project</p>
                <p>논현동 KJ빌딩 신축 계획</p>
                <p class="inner-text">Korea / Seoul Nonhyun KJ Blg Office Project</p>
                <p>신사동 리모델링 증축 계획</p>
                <p class="inner-text">Korea / Seoul Shinsa Hospital remodeling Project</p>
                <p>첨당동 KJ빌딩 증축 계획</p>
