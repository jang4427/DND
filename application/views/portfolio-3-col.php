...
<div class="container">
    ...
    <div class="row margin-top">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/11.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/12.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/13.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/14.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-7">
                <img   src="http://localhost/assets/img/15.jpg" alt="photo"/>
        </div>
        <div class="col-md-5">
